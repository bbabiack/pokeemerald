...
const struct TrainerBall gTrainerBallTable[] = {
    ...
    {TRAINER_CLASS_BEAUTY, ITEM_PREMIER_BALL},
    {TRAINER_CLASS_RICH_BOY, ITEM_LUXURY_BALL},
    {TRAINER_CLASS_POKEMANIAC, ITEM_POKE_BALL},
    ...
    {TRAINER_CLASS_CHAMPION, ITEM_POKE_BALL},
    ...
    {TRAINER_CLASS_PICNICKER, ITEM_LUXURY_BALL},
